...
const Adminusers = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await fetch("https://www.collegeforms.in/api/admin/users", {
          method: "GET",
          headers: {
  ...
  const changeStatus = async (userId, newStatus) => {
    try {
      const response = await fetch(`https://www.collegeforms.in/api/admin/users/${userId}/status`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleSaveRemark = async () => {
    ...
    try {
      const response = await fetch(`https://www.collegeforms.in/api/admin/users/${selectedUser._id}/remark`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
