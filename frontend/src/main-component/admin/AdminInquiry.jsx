...
const AdminInquiry = () => {
  ...
  const fetchApplications = async () => {
    try {
      const response = await axios.get("https://www.collegeforms.in/api/applications");
  ...
  const handleCheckboxChange = async (id) => {
    try {
      await axios.put(`https://www.collegeforms.in/api/applications/${id}/complete`);
  ...
  const handleNoteSave = async () => {
    if (note.trim()) {
      try {
        ...
        await axios.put(`https://www.collegeforms.in/api/applications/${currentAppId}/add-note`, { note });
