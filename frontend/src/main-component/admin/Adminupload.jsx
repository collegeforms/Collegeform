...
const AdminUpload = () => {
  ...
  const fetchCourses = async () => {
    try {
      const response = await axios.get('https://www.collegeforms.in/courses');
  ...
  const fetchLocations = async () => {
    try {
      const response = await axios.get('https://www.collegeforms.in/locations');
  ...
  const handleSubmitCourse = async (e) => {
    ...
    try {
      const response = await axios.post('https://www.collegeforms.in/courses', courseData);
  ...
  const handleSubmitLocation = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://www.collegeforms.in/locations', { name: location });
      if (response.status === 201) {
  ...
  const handleDeleteCourse = async (id) => {
    try {
      await axios.delete(`https://www.collegeforms.in/courses/${id}`);
  ...
  const handleDeleteLocation = async (id) => {
    try {
      await axios.delete(`https://www.collegeforms.in/locations/${id}`);
